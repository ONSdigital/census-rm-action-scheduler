...
public class FakeCaseRepository implements CaseRepository {
    ...
    public Stream<Case> findByActionPlanId(String actionPlanId) {
        return null;
    }
    ...
    public List<Case> findAll(Specification<Case> specification) {
        AssertionsForClassTypes.assertThat(specification).isEqualToComparingFieldByFieldRecursively(expectedSpec);
