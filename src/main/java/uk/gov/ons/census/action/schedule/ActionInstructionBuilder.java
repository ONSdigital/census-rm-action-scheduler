...
public class ActionInstructionBuilder {
  ...
  public uk.gov.ons.census.action.model.dto.instruction.field.ActionInstruction buildFieldActionInstruction(Case caze, ActionRule actionRule) {

    UacQidTuple uacQidTuple = getUacQidLinks(caze);

    uk.gov.ons.census.action.model.dto.instruction.field.ActionAddress actionAddress = new uk.gov.ons.census.action.model.dto.instruction.field.ActionAddress();
    actionAddress.setLine1(caze.getAddressLine1());
    actionAddress.setLine2(caze.getAddressLine2());
    actionAddress.setLine3(caze.getAddressLine3());
    actionAddress.setTownName(caze.getTownName());
    actionAddress.setPostcode(caze.getPostcode());
    actionAddress.setOrganisationName(caze.getOrganisationName());
    uk.gov.ons.census.action.model.dto.instruction.field.ActionRequest actionRequest = new uk.gov.ons.census.action.model.dto.instruction.field.ActionRequest();
    actionRequest.setActionId(UUID.randomUUID().toString());
    actionRequest.setResponseRequired(false);
    actionRequest.setActionPlan(actionRule.getActionPlan().getId().toString());
    ...
    uk.gov.ons.census.action.model.dto.instruction.field.ActionInstruction actionInstruction = new uk.gov.ons.census.action.model.dto.instruction.field.ActionInstruction();
    actionInstruction.setActionRequest(actionRequest);
